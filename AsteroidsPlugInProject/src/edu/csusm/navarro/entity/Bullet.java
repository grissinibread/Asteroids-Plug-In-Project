...
public class Bullet extends Entity {
	 ...
	 */
	public Bullet(Entity owner, double angle, IVectorFactory vectorFactory) {
		super(vectorFactory.createVector(owner.position), vectorFactory.createVector(angle).scale(VELOCITY_MAGNITUDE), 2.0, 0);
